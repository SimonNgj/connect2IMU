...
// CChartllDlg dialog
class CChartllDlg : public CDialog
{
// Construction
public:
	CChartllDlg(CWnd* pParent = nullptr);	// standard constructor
	~CChartllDlg();

// Dialog Data
	enum { IDD = IDD_CHARTLL_DIALOG };
	CButton m_PointerPB;
